...
public class HiloClienteUDP extends Thread {
    ...
    public void run() {
        try {
            for (Pregunta pregunta : preguntas) {
                ...
                escribirEnLog(respuestaCliente, clientAddress.getHostAddress());
    ...
    private void escribirEnLog(String respuesta, String ip) {
        ServidorUDP.escribirEnLog(respuesta, ip);
    }
}
